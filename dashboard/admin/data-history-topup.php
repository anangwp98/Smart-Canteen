      ...
      <div class="row mt-5">
        <div class="col-xl-12 mb-5 mb-xl-0">
          <div class="card shadow">
            ...
            <?php
            $data_topup_selsai = "SELECT topup.id_topup, user.nama, topup.jml_topup,  DATE_FORMAT(topup.tgl_topup, '%M %d %Y. Pukul  %H:%i:%s') as tanggal_topup FROM `topup` JOIN user ON topup.id_user=user.id_user WHERE user.level='user' AND topup.status='SELESAI'";
            ...
            if (($total_record_topup_selesai) > 0) {
